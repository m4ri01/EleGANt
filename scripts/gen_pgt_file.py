...
from training.dataset_modified import MakeupDataset
from training.solver_modified_file import Solver
...
def main(config, args):
    ...
    dataset = MakeupDataset(config,args)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("argument for generate pgt")
